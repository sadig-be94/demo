...
@section('body')
    <div class="row mt-5">
        <div class="col-lg-12 col-md-12 col-xl-12 col-xxl-12 h-100">
            ...
            <form class="p-0" method="post"  enctype="multipart/form-data" action="{{route('blog.store')}}">
                @CSRF
                    ...
                    <div class="col-md">
                        ...
                        <div class="dz-preview-cover d-flex align-items-center justify-content-center mb-3 mb-md-0">
                            <div class="avatar" style="width: 250px;">
                                <label class="form-label">Şəkil * (max-ölçü: 5 MB)</label>
                                <img id="output" src="/assets/img/img.png" alt="..." data-dz-thumbnail="data-dz-thumbnail" />
                            </div>
                        </div>
                        <script>
                ...
                <div class="col-lg-6 col-md-6 col-xl-6 col-xxl-6">
                    ...
                    <input class="form-control datetimepicker" value="{{@old('date')}}" name="date" id="datepicker" type="text" placeholder="d/m/y" data-options='{"disableMobile":true}' />
                </div>
                <div class="col-lg-6 col-md-6 col-xl-6 col-xxl-6">
                    ...
                    <input class="form-control datetimepicker" name="hour" id="timepicker1" type="text"
                           placeholder="H:i"  value="{{@old('hour')}}" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":false}' />
                </div>
                    <div class="mb-3"><label class="form-label" for="exampleFormControlInput1">Başlıq *</label>
                        <input class="form-control" value="{{@old('title')}}" name="title" type="text" /></div>
                    <div class="mb-3"><label class="form-label" for="exampleFormControlTextarea1">Content *</label>
                        <textarea class="form-control" name="text" rows="3">{{@old('text')}}</textarea></div>
                </div>
            <button class="btn btn-success me-1 mb-1 float-end" type="submit">Əlavə et</button>
         </form>
        </div>
    </div>
@endsection
